...
def make_args_parser():
    ...
    parser.add_argument("--dataset_name", default='scannet', type=str)
    parser.add_argument("--ckpts", default='/home/zhiminc/ckpt-last.pth', type=str)
    ...
    parser.add_argument("--batchsize_per_gpu", default=2, type=int)
...
def do_train(
    ...
    best_val_metrics50 = best_val_metrics
    ...
    for epoch in range(args.start_epoch, args.max_epoch):
        ...
        if epoch % args.eval_every_epoch == 0 or epoch == (args.max_epoch - 1):
            ...
            if is_primary() and (
                len(best_val_metrics50) == 0 or best_val_metrics50[0.5]["mAP"] < ap50
            ):
                best_val_metrics50 = metrics
                filename = "checkpoint_best50.pth"
                save_checkpoint(
                    args.checkpoint_dir,
                    model_no_ddp,
                    optimizer,
...
def main(local_rank, args):
    ...
    if args.ckpts != None:
        model.encoder.load_model_from_ckpt(args.ckpts)
